...
export default {
  ...
  computed: {
    ...mapState('addressbkks',['navigationList','navigationListSiyid','defaultSiyid'])
  },
  mounted() {
    //发送请求获取数据 起始数据是死的
  ...
  methods: {
    ...mapMutations("addressbkks",["navigationListpush",'navigationListpop','navigationListSiyidpush','navigationListSiyidpop']),
    gotodetail(value) {
      this.$router.push({
        name: "Details",
        params: {
